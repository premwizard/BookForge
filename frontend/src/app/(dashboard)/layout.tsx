...
import { BookOpen, FolderOpen, LayoutDashboard, Settings, LogOut, FileText, Workflow, Edit3, Download, Sparkles, Globe, Radio, Palette, Tablet, Archive, Calculator } from "lucide-react";
...
const sidebarLinks = [
  ...
  { href: "/dashboard/pod", label: "POD & Royalties", icon: Calculator },
  { href: "/dashboard/batch", label: "Batch Ingestion", icon: Archive },
